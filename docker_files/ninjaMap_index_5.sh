...
then
    s="singular"
    pileup.sh in=${NINJA_OUTPUT}/${SAMPLE_NAME}.singular.bam out=${NINJA_OUTPUT}/${s}_coverage.txt overwrite=t 2>${NINJA_OUTPUT}/${s}_stats.txt
    ...
    s="escrow"
    pileup.sh in=${NINJA_OUTPUT}/${SAMPLE_NAME}.escrow.bam out=${NINJA_OUTPUT}/${s}_coverage.txt overwrite=t 2>${NINJA_OUTPUT}/${s}_stats.txt
