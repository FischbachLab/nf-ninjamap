...
df = read_excel("~/Stanford/maf-nextflow/nf-ninjamap/scripts/abundance_plot/MITI-ninjaMap-table.xlsx", sheet = "Sheet2") 
...
summary(df)
 ...
 ggsave("~/Stanford/maf-nextflow/nf-ninjamap/scripts/abundance_plot/figures/MITI-001-BileAcids_ninjaMap.svg", height = 14, width = 16, units = "in", dpi = "retina")
